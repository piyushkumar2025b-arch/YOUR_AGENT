...
// Calculate real SHA-1 Git commit hash using WebCrypto
...
function generateInitialCommitsFromFiles(files: VirtualFile[], authorName: string, authorEmail: string): GitCommit[] {
  ...
  const h1 = "4f8a9b2c3d1e5a7b9c0d2e4f6a8b1c3d5e7f9a1b";
  const h2 = "8c2d4e6f1a3b5c7d9e0f2a4b6c8d1e3f5a7b9c2d";
  const h3 = "1a3b5c7d9e0f2a4b6c8d1e3f5a7b9c2d4e6f8a0b";
  const h4 = "7b9c1d3e5f7a9b1c3d5e7f9a1b3c5d7e9f1a3b5c";
